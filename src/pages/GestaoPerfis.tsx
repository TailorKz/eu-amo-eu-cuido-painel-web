...
export default function GestaoPerfis() {
  ...
  const handleSalvarPerfil = async () => {
    ...
    try {
      ...
      const setorFinal =
        novoPerfil === "CIDADAO" || novoPerfil === "SUPER_ADMIN"
          ? null
          : novoSetor;
  ...
  const getBadgePerfil = (perfil: string) => {
    switch (perfil) {
      ...
      default:
        return "bg-gray-100 text-gray-700"; // CIDADAO
    }
  };
              ...
              {isLoading ? (
                ...
                usuarios.map((user) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-bold ${getBadgePerfil(user.perfil)}`}
                      >
                        {user.perfil
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primaryDark transition-colors disabled:opacity-50"
                >
